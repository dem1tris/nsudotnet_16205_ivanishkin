...
namespace task4_effective_worker.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,FirstName,Patronymic,LastName,Cabinet")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,FirstName,Patronymic,LastName,Cabinet")] Employee employee)
        {
